...
DB_USER                    = os.getenv("DB_RESPAT_USER")
DB_PASSWORD                = os.getenv("DB_RESPAT_PASSWORD")
...
DB_DAGSTER_RESPAT_USER     = os.getenv("DB_DAGSTER_RESPAT_USER")
DB_DAGSTER_RESPAT_PASSWORD = os.getenv("DB_DAGSTER_RESPAT_PASSWORD")
DB_DAGSTER_RESPAT_DATABASE = os.getenv("DB_DAGSTER_RESPAT_DATABASE")
